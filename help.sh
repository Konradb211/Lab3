...
function show_help() {
  ...
  echo "-l, --logs  tworzy plik log zawierający nazwę pliku, nazwę skryptu i datę"
  echo "-h, --help  wyświetla komendy"
  echo "-e, --error tworzy plik error z informacją o błędzie"
}
